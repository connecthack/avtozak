 ...
 * });
 */
export function usePrisonerQuery(baseOptions: Apollo.QueryHookOptions<PrisonerQuery, PrisonerQueryVariables> & ({ variables: PrisonerQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function usePrisonerSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<PrisonerQuery, PrisonerQueryVariables>) {
...
export function usePrisonersSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<PrisonersQuery, PrisonersQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
...
export function usePrisonerStatusCountsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<PrisonerStatusCountsQuery, PrisonerStatusCountsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
